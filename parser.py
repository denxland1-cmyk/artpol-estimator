...
Правила:
- client_name: имя клиента/заказчика если упомянуто в тексте (например "Алексей", "Иванов Пётр"). Имя может стоять на одной строке с телефоном: "Иван 89001234567" — client_name="Иван", client_phone="89001234567". Имя может быть ЛЮБЫМ словом (в т.ч. нестандартным) перед или после телефона.
